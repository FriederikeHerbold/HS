...
public class Baum<B, T> implements AssoziativesArray {
	...
	/**
	 * Hilfsmethode, sucht Knoten, der vor dem zu lˆschemden Knoten steht
	 * 
	 * @param knoten
	 * @param schluessel
	 * @return
	...
	/**
	 * Konvertiert alle Knoten in einen fortlaufenden String f¸r die Ausgabe
	 * 
	...
	/**
	 * Fuehrt zuerst den linken Teilbaum, dann die Wurzel und schlieﬂlich den
